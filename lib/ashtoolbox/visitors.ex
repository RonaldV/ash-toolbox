...
defmodule Ashtoolbox.Visitors do
  use GenServer
  ...
  def handle_call(:add, _, state) do
    ...
    Phoenix.PubSub.broadcast(Ashtoolbox.PubSub, "visitors", %{event: "add"})
  ...
  def handle_call(:remove, _, state) do
    ...
    Phoenix.PubSub.broadcast(Ashtoolbox.PubSub, "visitors", %{event: "remove"})
    {:reply, {:ok, new_state}, new_state}
  end
